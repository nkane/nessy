...
func Open(rom *nes.ROM) (Cartridge, error) {
	...
	case 85:
		return NewVRC7(rom)
	default:
		return nil, fmt.Errorf("cart: unsupported mapper %d (NROM/0, MMC1/1, UxROM/2, CNROM/3, MMC3/4, MMC5/5, AOROM/7, VRC2/4/21,22,23,25, VRC6/24,26, FME-7/69, VRC7/85)", rom.Mapper)
	}
}
